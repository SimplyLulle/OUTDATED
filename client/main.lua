	...
	ESX.UI.Menu.Open(
		'default', GetCurrentResourceName(), 'cloakroom',
		{
			...
			elements = {
				...
				{label = _U('cadet_wear'), value = 'cadet_wear'},
				{label = _U('police_wear'), value = 'police_wear'},
				{label = _U('sergent_wear'), value = 'sergent_wear'},
				{label = _U('lieutenant_wear'), value = 'lieutenant_wear'},
				{label = _U('commandant_wear'), value = 'commandant_wear'},
				{label = _U('veste_wear'), value = 'veste_wear'},
				{label = _U('gilet_wear'), value = 'gilet_wear'},
				{label = _U('giletj_wear'), value = 'giletj_wear'},
				{label = _U('rgiletj_wear'), value = 'rgiletj_wear'},
			},
		},
		function(data, menu)
			...
			if data.current.value == 'giletj_wear' then
				...
				ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function()
			if(GetEntityModel(GetPlayerPed(-1)) == hashSkin) then --Sert a positionner la tenue sur le perso
			...
			if data.current.value == 'rgiletj_wear' then
